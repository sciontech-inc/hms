...
@section('breadcrumbs')
    <span>TRANSACTIONS</span> / <span class="highlight">PHARMACY</span>
@endsection
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">PHARMACY: TRANSACTION SCREEN</h5>
            </div>
            @include('backend.partial.flash-message')
            <div class="col-12">
                <div class="card-body">
                    <table id="pharmacy_table" class="table table-striped" style="width:100%"> </table>
                </div>
            </div>
        </div>
    </div>
...
@section('sc-modal')
@parent
<div class="sc-modal-content" id="pharmacy_form">
    <div class="sc-modal-dialog">
        <div class="sc-modal-header">
            <span class="sc-title-bar"></span>
            <span class="sc-close" onclick="scion.create.sc_modal('pharmacy_form').hide('all', modalHideFunction)"><i class="fas fa-times"></i></span>
        </div>
        <div class="sc-modal-body">
            <form method="post" id="pharmacyForm" class="form-record">
                <div class="row">
                    <div class="form-group col-md-6 medication_id">
                        <label>MEDICATION ID</label>
                        <input type="text" class="form-control" id="medication_id" name="medication_id"/>
                    </div>
                    <div class="form-group col-md-6 medication_name">
...
@section('scripts')
    ...
    <script src="/js/backend/pages/hms/pharmacy/pharmacy.js"></script>
@endsection