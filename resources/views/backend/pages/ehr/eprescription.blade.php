...
@endsection
@section('breadcrumbs')
    <span>EHR</span> / <span class="highlight">ePrescription</span>
@endsection
...
@section('sc-modal')
@parent
<div class="sc-modal-content" id="eprescription_form">
    <div class="sc-modal-dialog">
        <div class="sc-modal-header">
            <span class="sc-title-bar"></span>
            <span class="sc-close" onclick="scion.create.sc_modal('eprescription_form').hide('all', modalHideFunction)"><i class="fas fa-times"></i></span>
        </div>
        <div class="sc-modal-body">
            <form method="post" id="ePrescriptionForm" class="form-record">
                <div class="row">
...
@section('scripts')
    ...
    <script src="/js/backend/pages/hms/ehr/eprescription.js"></script>
