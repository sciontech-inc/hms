<div id="vital_measurement_tab" class="form-tab">
    <h5>VITAL SIGNS AND MEASUREMENTS</h5>
    ...
    <div class="sc-modal-content" id="vital_measurement_form">
        <div class="sc-modal-dialog">
            ...
            <div class="sc-modal-body">
                <form id="vitalmeasurementForm" method="post" class="form-record">
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-6">
                            <div class="form-group oxygen_rate">
                                <label>OXYGEN SATURATION <span class="required">*</span></label>
                                <input type="text" class="form-control" name="oxygen_rate" id="oxygen_rate"/>
                            </div>
                        </div>
                        <div class="col-6">
